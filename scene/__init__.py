...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, params: PriorParams, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = readColmapSceneInfo(args.source_path, args.eval)
        else:
        ...
        for resolution_scale in resolution_scales:
            ...
            self.train_cameras[resolution_scale] = cameraList_from_camInfos(scene_info.train_cameras, resolution_scale, args, params)
